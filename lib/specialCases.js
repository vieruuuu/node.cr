...
function isSymbol(callee) {
  return callee && callee.type === "Identifier" && callee.name === "Symbol";
}

function isRange(callee) {
  return (
    callee &&
    callee.type === "Identifier" &&
    (callee.name === "Range" || callee.name === "InclusiveRange")
  );
}

function isExclusiveRange(callee) {
  return (
    callee && callee.type === "Identifier" && callee.name === "ExclusiveRange"
  );
}
